...
"""Simplified state changer for block steps."""

from typing import TYPE_CHECKING

from ..states import BLOCK_TRANSITIONS
...
class BlockStateChanger(StateChanger):
    ...
    Implements simplified state machine:
    - Created -> BlockExecutionBegin
    - BlockExecutionBegin -> BlockExecutionContinue
    - BlockExecutionContinue -> BlockExecutionEnd (when all children complete)
