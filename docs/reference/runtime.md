...
> See [runtime-impl.md](runtime-impl.md) §4.3 for Python transition tables and StateChanger class hierarchy.
...
> **Implemented** — see `examples.md` Example 4 for the authoritative execution trace.
...
> See [runtime-impl.md](runtime-impl.md) §10 for catch handler implementations.
...
> See [runtime-impl.md](runtime-impl.md) §4.3 for the `SCHEMA_TRANSITIONS` table.
...
> See [runtime-impl.md](runtime-impl.md) §2 for the `Evaluator` class and iteration loop implementation.
...
> **Implemented** — see `examples.md` Example 4, Iteration 1.
...
> **Implemented** — see `examples.md` Example 4 for the full two-run trace.
...
> **Implemented** — see `runtime-impl.md` §17.5.1 for the full implementation details.
...
> **Implemented** — see `runtime-impl.md` §17.5.2 for the full implementation details.
...
> **Implemented** — see `examples.md` Example 4 for the full interaction model.
...
> For the Python reference implementation (state changers, handlers, transition tables, source file map), see [runtime-impl.md](runtime-impl.md).
