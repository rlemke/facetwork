...
| [`paper-completion-and-portability.md`](docs/thesis/paper-completion-and-portability.md) / [`.pdf`](docs/thesis/paper-completion-and-portability.pdf) | *Green Is Not Done* — nine silent failures on the path to a complete OSM extraction (recovery paths that drop guarantees; no-ops that report success), and the capacity recovered by multi-architecture images (32–71× measured) |
